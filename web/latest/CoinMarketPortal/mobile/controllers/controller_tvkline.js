	...
	function getMarketTicks() {
		TradingView.onready(function() {
			var widget = window.tvWidget = new TradingView.widget({
				...
				disabled_features: [  "header_widget", "study_templates", "left_toolbar", "control_bar", "timeframes_toolbar", "header_settings", "header_undo_redo", "header_interval_dialog_button", "header_screenshot", "header_saveload", "display_market_status", "use_localstorage_for_settings", "volume_force_overlay" ],
