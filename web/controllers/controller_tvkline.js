	...
	function getMarketTicks() {
		TradingView.onready(function() {
			var widget = window.tvWidget = new TradingView.widget({
				...
				disabled_features: [ "study_templates", "left_toolbar", "control_bar", "timeframes_toolbar", "header_undo_redo", "header_interval_dialog_button", "header_screenshot", "header_saveload" ],
